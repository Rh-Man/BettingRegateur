...
export default function BettingDetails() {
  ...
  return (
    <div>
      <Link
        href="/dashboard/betting/history"
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Informations du pari</CardTitle>
            </CardHeader>
            <CardContent className="grid grid-cols-2 gap-4 text-sm">
              ...
              <Info
                label="Mise"
                value={<span className="font-semibold">{formatXOF(bet.stake)}</span>}
              />
              <Info
                label="Montant payé"
                value={<span className="font-semibold">{formatXOF(bet.payout)}</span>}
              />
              ...
              <Info
                ...
                value={
                  <div className="flex items-center gap-2">
                    <OperatorLogo name={bet.operator.name} color={bet.operator.color} size={20} />
                    {bet.operator.name}
                  </div>
                }
              />
