          ...
          <Card>
            ...
            <CardContent className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input defaultValue="Aminata Diallo" />
              </div>
              <div className="space-y-2">
                <Label>Email</Label>
                <Input defaultValue="a.diallo@lonase.sn" />
              </div>
              <div className="space-y-2">
                <Label>Téléphone</Label>
                <Input defaultValue="+221 77 555 12 34" />
              </div>
              <div className="space-y-2">
                <Label>Département</Label>
                <Input defaultValue="Régulation" />
              </div>
              <div className="space-y-2">
                <Label>Poste</Label>
        ...
        <TabsContent value="security" className="mt-4 space-y-4">
          ...
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground">
              18 mai 2026 à 09:42 · Dakar, SN · Chrome / macOS
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
