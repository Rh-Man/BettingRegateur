    ...
    <div>
      ...
      <Tabs defaultValue="general">
        ...
        <TabsContent value="general" className="mt-4 grid lg:grid-cols-3 gap-6">
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              <div className="flex items-center gap-2">
                <User className="h-4 w-4 text-muted-foreground" /> {u.fullName}
              </div>
              <div className="flex items-center gap-2">
                <Phone className="h-4 w-4 text-muted-foreground" /> {u.phone}
              </div>
              <div className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-muted-foreground" /> {u.email}
              </div>
              <div className="flex items-center gap-2">
                <MapPin className="h-4 w-4 text-muted-foreground" /> Dakar, SN
              </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Paris par type de jeu</CardTitle>
            </CardHeader>
            <CardContent>
...
function Stat({
  ...
  return (
    <div className="p-3 rounded-lg bg-muted/40">
      ...
      <p
        className={`text-base font-semibold mt-1 ${tone === "success" ? "text-success" : tone === "warning" ? "text-warning" : ""}`}
      >
        {value}
      </p>
    </div>
