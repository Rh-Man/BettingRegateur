...
export const Route = createFileRoute("/payments/wallets")({
  component: WalletsPage,
  head: () => ({ meta: [{ title: "Portefeuilles" }] }),
});
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        ...
        <KPICard title="Wallets actifs" value={`${wallets.filter(w => w.active).length}`} icon={CheckCircle2} accent="success" />
            ...
            <CardHeader className="flex flex-row items-center justify-between pb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">Actif · {formatNumber(w.transactions)} transactions</p>
                </div>
              </div>
              <Button variant="outline" size="sm"><History className="h-3.5 w-3.5 mr-1.5" />Historique</Button>
            </CardHeader>
            <CardContent>
