        ...
        <CardContent className="p-8">
          <div className="flex items-center justify-between mb-8">
            {STEPS.map((s, i) => (
              <div key={s} className="flex items-center gap-3 flex-1">
                <div className={cn("h-9 w-9 rounded-full flex items-center justify-center text-sm font-medium border-2",
          ...
          <div className="flex justify-between mt-6">
            ...
            {step < 2 ? (
              ...
              <Button onClick={() => navigate({ to: "/dashboard" })}>Accéder au dashboard</Button>
            )}
          </div>
        </CardContent>
      </Card>
