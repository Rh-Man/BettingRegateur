    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-muted/30">
      <Card className="w-full max-w-md">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-sm text-muted-foreground mt-2">Saisissez le code à 6 chiffres envoyé sur votre téléphone.</p>
          ...
          <Button className="w-full mt-6" disabled={code.length < 6} onClick={() => navigate({ to: "/dashboard" })}>
            Valider
          </Button>
